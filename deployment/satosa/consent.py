...
class Consent(ResponseMicroService):
    ...
    def _handle_consent_response(self, context):
        ...
        hash_id = self._get_consent_id(internal_response.requester,
    ...
    def process(self, context, internal_response):
        ...
        id_hash = self._get_consent_id(internal_response.requester,
                                       internal_response.attributes)
    ...
    def _get_consent_id(self, requester, filtered_attr):
        """
        ...
        id_string = "%s%s" % (requester, hash_str)
